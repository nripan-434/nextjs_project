      ...
      <div className="max-w-[1400px] w-full mx-auto flex justify-center gap-6 p-4 flex-1">
        ...
        <aside className="hidden lg:flex flex-col w-[250px] shrink-0 sticky top-4 h-[calc(100vh-2rem)]">
          ...
          <button
            ...
            className="w-full mb-6 py-2.5 px-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-semibold text-xs rounded-xl shadow-lg shadow-purple-600/20 transition-all flex items-center justify-center gap-2"
          >
          ...
          <nav className="flex flex-col gap-1 flex-grow">
            ...
            <NavItem icon={CodeIcon} label="My Workspaces" onClick={() => setIsCreateProjectOpen(true)} />
...
function NavItem({ icon: Icon, label, active, badge, onClick }: any) {
  return (
    <div onClick={onClick} className={`flex items-center justify-between p-2.5 rounded-xl cursor-pointer transition ${active ? 'bg-orange-500/10 text-orange-500' : 'text-neutral-400 hover:text-gray-200 hover:bg-neutral-800/50'}`}>
      <div className="flex items-center gap-3">
